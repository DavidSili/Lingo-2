...
$pass2html.='<div class="backlink" style="border-bottom: thin solid #000" onclick="ajax_request('.$ID.')" ><div><div title="'.$coma.'" style="border-right: thin dashed #000">'.$aa.'</div><div title="'.$comb.'">'.$bb.'</div></div>';
